        ...
        <div class="banner">
            <div class="imgWrap"
                ...
                <img
                    :src="banner.imgSrc" 
                    :alt="banner.name" 
                    @click="gotoPage(banner.imgSrc)" />
            </div>
        </div>
        <h2><span>I</span>NTRO <span>D</span>ESIGN</h2>
        <div class="intro">
            <div class="imgWrap"
...
export default {
    data() {
        return {
            snsdesigns: [
                {name: 'KOMONT intro', imgSrc: "https://eunseon-portfolio.netlify.app/img/11_intro.jpg"},
